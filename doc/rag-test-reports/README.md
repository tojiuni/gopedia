...
리포트에서 인용한 **aggregate** 지표(소수 **둘째 자리** 반올림). 앞 7점은 **`universitas_factual_v1` 44q**와 동일 정의(연속 추세로 읽을 수 있음). **`v0.8.x`·`v0.9.0`** 은 **osteon 30q** — **7↔8 구간**은 서로 **다른 데이터셋**이므로 개선/악화로 해석하지 말 것. (v0.1.0은 [수동 쿼리](v0.1.0_2026-04-01_neunexus-gopedia.md)만 있음.)

```mermaid
xychart-beta
    title "IR aggregate (앞 7: universitas 44q, v0.8.x/v0.9.0: osteon 30q)"
    x-axis [v0.2, v0.3, v0.4, "v0.5.0", "v0.5.1", "v0.6a", "v0.6b", "v0.8.0", "v0.8.1", "v0.9.0"]
    y-axis "score" 0.0 --> 1.0
    line [0.79, 0.64, 0.50, 0.50, 0.61, 0.50, 0.48, 1.00, 0.88, 0.90]
    line [0.39, 0.56, 0.32, 0.28, 0.37, 0.36, 0.37, 0.95, 0.95, 0.95]
    line [0.49, 0.58, 0.37, 0.34, 0.45, 0.40, 0.40, 0.96, 0.87, 0.89]
```

| 시리즈 | v0.2 → v0.6b (44q) | v0.8.0 (osteon 30q) | v0.8.1 (osteon 30q) | v0.9.0 (osteon 30q) | 출처 |
|--------|-------------------|---------------------|---------------------|---------------------|------|
| **Recall@5** | 0.79, 0.64, 0.50, 0.50, 0.61, 0.50, 0.48 | **1.00** | **0.88** | **0.90** | 44q: [v0.2.0](v0.2.0_2026-04-01_neunexus-gopedia.md)…[v0.6.0 04-03](v0.6.0-reingest_2026-04-03_universitas-factual.md) · [v0.8.0](v0.8.0_2026-05-03_graphdb-baseline.md) · [v0.8.1](v0.8.1_2026-05-04_qrel-expansion-v3.md) · [v0.9.0](v0.9.0_2026-05-04_graphdb-active.md) |
| **MRR@10** | 0.39, 0.56, 0.32, 0.28, 0.37, 0.36, 0.37 | **0.95** | **0.95** | **0.95** | 출처는 위와 동일 |
| **nDCG@10** | 0.49, 0.58, 0.37, 0.34, 0.45, 0.40, 0.40 | **0.96** | **0.87** | **0.89** | 동일 |
| **P@3** | 0.21, 0.21, 0.14, 0.14, 0.17, 0.17, 0.16 | **0.33** | **0.39** | **0.37** | 출처는 위와 동일. v0.9.0 하락은 graph 결과가 top-3 경쟁 |
